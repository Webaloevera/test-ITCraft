...
const AddNote = ({onCreate}) => {
    ...
    return (
        <div className="note_editor">
            <div className="note_editor-search">
                <input placeholder="Search by title" type="text"/>
            </div>
            <div className="note_editor-panel">
            <button className="trash">
            <svg id="Layer_1" height="20" fill="#fff" viewBox="0 0 512 512" width="30" xmlns="http://www.w3.org/2000/svg">
            ...
            <form onSubmit={submitHandler}>
                ...
                <div>
                    <p>Description</p>
                    <textarea value={desk} onChange={event => setDesc(event.target.value)}></textarea>
                </div>
